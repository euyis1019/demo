...
| 3 | 附录 D 仅验收 Turn 1 | DoD 是「本地能玩」；**通完 25 Turn 主线路**见 **F8 `dev_logs/19_HBM_Demo_25轮参考台词.md`**，非 F6 必验项 |
...
| F8 | `dev_logs/19_HBM_Demo_25轮参考台词.md` 25 轮参考台词（**完整通关验证**，见 §五 #3） | ✅ |
...
> **范围说明（§五 #3）**：本清单验证「本地一行命令 + Turn 1 可玩」，**不要求**在此阶段通完 25 Turn。完整主线路试玩见 **F8 `dev_logs/19_HBM_Demo_25轮参考台词.md`**。

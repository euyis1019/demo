...
用法：
    python3 -m agent_world.hbm_demo.scripts.ops.generate_assets canglan_sword
    python3 -m agent_world.hbm_demo.scripts.ops.generate_assets canglan_sword --all
    python3 -m agent_world.hbm_demo.scripts.ops.generate_assets canglan_sword --limit 2

需在 agent_world/hbm_demo/.env 配置 ARK_API_KEY=ark-...（火山 Ark），否则提示配置。
"""

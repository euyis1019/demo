...
def test_f12_phase1_persistence() -> None:
    ...
    from agent_world.hbm_demo.scripts.tests.acceptance import f12_phase1
...
def test_f12_phase2_world_delta() -> None:
    ...
    from agent_world.hbm_demo.scripts.tests.acceptance import f12_world_delta
...
def test_f12_visibility_no_hidden() -> None:
    ...
    from agent_world.hbm_demo.scripts.tests.acceptance import f12_visibility
...
def test_f07_e_step5_phase4_smoke_module() -> None:
    ...
    from agent_world.hbm_demo.features import FEATURE_REGISTRY
    from agent_world.hbm_demo.features.f07_agent_control.config import is_f07_enabled
    from agent_world.hbm_demo.scripts.tests.acceptance.phase4_smoke import (
        Phase4SmokeResult,
    ...
    smoke_src = (
        HBM_DIR / "scripts" / "tests" / "acceptance" / "phase4_smoke.py"

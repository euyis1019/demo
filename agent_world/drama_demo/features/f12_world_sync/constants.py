...
DRAMA_ROOM_PLACES: tuple[str, ...] = ()

DRAMA_AGENT_IDS: tuple[int, ...] = ()
...
def room_places() -> tuple[str, ...]:
    ...
    try:
        ...
        return ids or DRAMA_ROOM_PLACES
    except Exception:  # noqa: BLE001
        return DRAMA_ROOM_PLACES
...
def agent_roster() -> tuple[int, ...]:
    ...
    try:
        ...
        return ids or DRAMA_AGENT_IDS
    except Exception:  # noqa: BLE001
        return DRAMA_AGENT_IDS

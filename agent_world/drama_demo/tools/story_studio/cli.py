...
用法：
  python3 -m agent_world.drama_demo.tools.story_studio.cli validate-brief <brief.yaml>
  python3 -m agent_world.drama_demo.tools.story_studio.cli compile <story_id> <sections.(yaml|json)>
  python3 -m agent_world.drama_demo.tools.story_studio.cli generate <brief.yaml>   # G2 实现(需 LLM)
"""
...
from agent_world.drama_demo.tools.story_studio.brief_schema import validate_brief
from agent_world.drama_demo.tools.story_studio.orchestrator import compile_pack
...
def _cmd_review(args: argparse.Namespace) -> int:
    ...
    from agent_world.drama_demo.tools.story_studio.review import render_review
...
def _cmd_generate(args: argparse.Namespace) -> int:
    ...
    from agent_world.drama_demo.tools.story_studio.base_agent import StoryStudioError
    from agent_world.drama_demo.tools.story_studio.llm_client import make_llm_client
    from agent_world.drama_demo.tools.story_studio.metering import GenerationTrace

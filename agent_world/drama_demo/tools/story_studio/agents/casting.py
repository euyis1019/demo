...
只输出 JSON：
{
  "agents": [{"agent_id": 整数, "name": "", "location": "地点id", "role": "", "faction": "",
              ...
              "soul": "性格/价值观（2-3 句，立体有棱角；写出一个鲜明欲望 + 一个缺陷/软肋）",
              "speech_style": "说话风格：语气/用词习惯/口头禅/称谓/对不同人态度的差别（1-2 句，要有辨识度）",
              "speech_samples": ["该角色 2-3 条典型台词原话，直接示范他的口吻/口头禅/对人态度（演员据此学语气）"],
              "inner": "内心戏（第二人称写）：你的秘密/真实动机/顾忌/在本故事里真正图谋什么"
                       "——只有你自己知道、不会对玩家明说、却暗中支配你的一言一行（2-3 句）",

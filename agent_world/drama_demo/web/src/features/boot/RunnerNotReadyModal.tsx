...
import { RUN_DRAMA_COMMAND } from "../../constants/runner";
...
/** F5-2 — 503 Runner 未就绪 Modal，可复制 run_drama 命令。 */
export function RunnerNotReadyModal({
  open,
  onClose,
  onRetryHealth,
  command = RUN_DRAMA_COMMAND,
  detail = "Runner 未就绪或 world.db 不可读。请在仓库根目录启动 run_drama，并确保 Flask 使用同一 sim_dir。",

...
用法：
  python3 agent_world/drama_demo/scripts/ops/validate_story_pack.py            # 校验全部 pack
  python3 agent_world/drama_demo/scripts/ops/validate_story_pack.py <story_id> # 校验单个

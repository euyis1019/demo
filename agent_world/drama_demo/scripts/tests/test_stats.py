...
import agent_world.drama_demo.game_service  # noqa: F401  建立正确加载顺序，避开 f04↔f01 循环导入
from agent_world.drama_demo.features.f04_stats.deltas import apply_stat_deltas
from agent_world.drama_demo.features.f04_stats.scoring import _heuristic_stats

...
# 口碑流动软引导（焐心小镇支柱4）：第 6 段收尾点一句——街坊爱互相说道镇上
# 人事，让"你对谁好、谁帮过你"在 NPC 间自然传开。传不传、对谁传、怎么传
# 全凭你的性格与当下心境（话多的多念叨、话少的少说，都正常）。
REPUTATION_NOTE = (
    "镇上谁来了、谁帮过谁、谁人怎么样，街坊之间平时爱互相说道——"
    "当面唠两句、或在镇民群里提一嘴都成；你对眼前人的看法，"
    "自然会在和别人的闲聊里流露出来（说多说少看你性子）。"
)
